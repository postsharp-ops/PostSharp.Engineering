...
public static partial class MetalamaDependencies
{
    ...
    // TODO: rename this to V2025_1 once the Metalama.Framework.2025.1 repo is no longer needed (and after changing Metalama's customRepositoryName back)
    [PublicAPI]
    public static class V2025_1_WithPremium
    {
        ...
        public static ProductFamily Family { get; } = new( _projectName, "2025.1 with Premium", DevelopmentDependencies.Family, PostSharpDependencies.V2025_1.Family )
        {
        ...
        public static DependencyDefinition Metalama { get; } = new MetalamaDependencyDefinition(
            "Metalama",
            VcsProvider.GitHub,
            customRepositoryName: "Metalama.Framework.2025.1" );
