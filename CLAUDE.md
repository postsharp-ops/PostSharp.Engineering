...
## Generated scripts
- Never update DockerBuild.ps1, Dockerfile. Dockerfile.claude, eng/RunClaude.ps1, Orchestrator.ps1. These files are generated by `Build.ps1`. Their source code is in the Resources directory.
- Orchestrator.ps1 is generated only in a consolidated repository, and its product list comes from the `SourceDependencies` of the consolidated product. Add a product there, not in the script.
